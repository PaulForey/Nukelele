...
package org.si.sion.effector {
    ...
    //------------------------------------------------------------
         ...
         *  @param gain gain [dB].
         */
        function SiFilterHighBoost(freq:Number=5500, slope:Number=1, gain:Number=6) 
        {
    ...
    //------------------------------------------------------------
         ...
         *  @param gain gain [dB].
         */
        public function setParameters(freq:Number=5500, slope:Number=1, gain:Number=6) : void {
            if (slope<1) slope = 1;
            var A:Number   = Math.pow(10, gain*0.025),
                ...
                alp:Number = sin * 0.5 * Math.sqrt((A + 1/A)*(1/slope-1)+2),
                alpsA2:Number = alp * Math.sqrt(A) * 2,
