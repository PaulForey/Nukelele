package org.si.sion.module {
    ...
    public interface ISiOPMWaveInterface {
         ...
         */
        function setPCMWave(index:int, data:*, samplingNote:Number=68, keyRangeFrom:int=0, keyRangeTo:int=127, srcChannelCount:int=2, channelCount:int=0) : SiOPMWavePCMData;
